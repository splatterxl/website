          ...
          <ol className="relative border-l border-gray-200 dark:border-gray-500 mx-2">
            <li className="mb-10 ml-4">
              ...
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white">
                Dived into Programming
              </h3>
              <p className="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">
                I was bored in the COVID-19 lockdown and decided to learn
                programming. I created my first ever project, a website for an
                imaginary company. While it wasn&apos;t pretty, I learned core
                programming concepts while making it and I don&apos;t regret it
                at all.
              </p>
            </li>
            <li className="mb-10 ml-4">
              ...
              <p className="text-lg font-normal text-gray-500 dark:text-gray-400">
                I started tinkering with different JavaScript libraries and
                discovered the interactive Discord bots – apps inside the chat
                platform that can respond to commands and interact with other
                users.
              </p>
              <a
            ...
            <li className="ml-4">
              ...
              <p className="text-lg font-normal text-gray-500 dark:text-gray-400">
                I learnt new programming languages like Rust, Elixir and Python.
                I experimented with technologies like React, Docker and Git. I
                furthered my skills in web development and studied UI/UX courses
                to understand intuitive design.
              </p>
            </li>
          </ol>
